...
Source0  : https://download.kde.org/stable/kirigami-addons/kirigami-addons-1.3.0.tar.xz
Source1  : https://download.kde.org/stable/kirigami-addons/kirigami-addons-1.3.0.tar.xz.sig
...
%setup -q -n kirigami-addons-1.3.0
cd %{_builddir}/kirigami-addons-1.3.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719443434
mkdir -p clr-build
pushd clr-build
