...
Source0  : https://download.kde.org/stable/kirigami-addons/kirigami-addons-1.0.1.tar.xz
Source1  : https://download.kde.org/stable/kirigami-addons/kirigami-addons-1.0.1.tar.xz.sig
...
%prep
%setup -q -n kirigami-addons-1.0.1
cd %{_builddir}/kirigami-addons-1.0.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710365294
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/qt6/qml/org/kde/kirigamiaddons/components/MessageDialogButton.qml
/usr/lib64/qt6/qml/org/kde/kirigamiaddons/components/MessageDialogButtonBox.qml
